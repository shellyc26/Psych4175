...
You can reach Dr. Cooper via the contact form on the homepage of this site, or you can email her at [shelly.cooper@wustl.edu](mailto:shelly.cooper@wustl.edu).
...
#### Aritifical Intelligence (Chat-GPT etc.) Policy
...
- You are allowed to use Chat-GPT. If you do, in your assignment, please say "I used Chat-GPT and here is the prompt that I used to generate this code: ____" and provide the prompt. This way, I can help make sure you understand why the code works or does not work.
