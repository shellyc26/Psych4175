...
- Fall 2026 L33-PSYCH 3175-01
- Monday/Wednesday 11:30am-12:50am
- Eads Room 102 (in-person instruction)
- Prereq: Psych 300/3000 or equivalent

## Who are we?

Instructor: **Shelly Cooper, PhD (she/her)** [shelly.cooper@wustl.edu](mailto:shelly.cooper@wustl.edu)
<br>
Office Hours: Mondays 1-2pm, Somers Family Hall 453A
<br>
Schedule an appointment with me on [Calendly](https://calendly.com/shelly-cooper/30min)

Assistant to the Instructor: **Jasmine Moon (she/her)** [jasmine.moon@wustl.edu](mailto:jasmine.moon@wustl.edu)
<br>
Office Hours: By appointment

## Course Description from Workday
This course is designed to introduce `R` as both a means of applied statistical analysis as well as a window into data organization and programming. The goal of the course is to teach the tools needed to take a raw dataset and not only perform a statistical test in `R`, but also to learn how to arrange the dataset to perform a variety of tests, to choose the appropriate test, and to visualize the results. Students will gain practical knowledge of how to use statistics in research. Please note that this is an introductory course and knowledge of `R` prior to enrollment is not expected. PREREQ: Psych 300/ 3000

## What's the course philosophy?
Programming & statistics are necessary skills across a wide variety of fields, including psychology, neuroscience, and other related disciplines. The goal of this course is for you to feel comfortable with the programmatic skills needed to take a data analysis project from start to finish including data wrangling, executing appropriate statistical tests, interpreting the results, and communicating your findings. Although we will use `R` software, the core concepts should carry with you to other programming languages (Python, MATLAB etc.).
...
There are no required textbooks or solid materials -- only the software mentioned above
  
## How do I get a good grade?
There are no exams! Hooray! To get a good grade in this class, you need to do the following:

  - **Quizzes** will take place every Wednesday before class begins. They will be a combination of multiple choice, true/false, and writing code by hand. They will not be long quizzes (10 questions at most), but they are meant to ensure you can think through the concepts.
...
\text{Quizzes 13 x 10pts/ea = 130pts}
\text{Solo Assignments 8 x 10 pts/ea = 80pts} \\
\text{Peer Reviews 8 x 3pts/ea = 24pts} \\
\text{Group Assignments 3 x 10pts/ea = 30pts} \\
\text{Final Project 1 x 20pts/ea = 20pts} \\
\text{Participation 16 (adjusted) x 1pts/ea = 16pts} \\
\mathbf{\text{Total = 300pts}}
...
#### Artificial Intelligence (Chat-GPT etc.) Policy
New Artificial Intelligence tools like Anthropic and OpenAI are rapidly changing the landscape of how we write code. These tools are truly wonderful for writing code quickly. They are used frequently outside of the classroom for writing code in a variety of languages, including R. 

HOWEVER, you signed up for this class because you wanted to learn how to write code. Current tools can get you through the basics but without an understanding of fundamentals, you can be lead down the wrong path. 

Therefore, the policy of this class is that artificial intelligence tools are NOT ALLOWED to write the R code that you turn in for any graded work unless otherwise specified. You may use them as pedagogical tools (i.e., "I was asked to write a custom function but I don't really understand the principles, can you describe them to me") and you may use them for clarifying error messages. But they are prohibited from writing the actual code that you turn in.

Artificial Intelligence tools are very tempting for this particular class. Especially because the beginning is hard. But please trust me when I say that you are shooting yourself in the foot and hindering your later self if you take the easy way out. Ask me more on this whenever you'd like. 
...
## Getting Help
- Me and the AI are here to help you. Full stop. It is our job. We get paid for it. Please come find us if you are struggling and need help.
