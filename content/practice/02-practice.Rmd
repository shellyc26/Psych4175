...
decorate("obj-form", eval=FALSE) %>% 
  flair("nameOfMyObject", background = "#fffe95") %>% 
  flair("<-", background = "#ff7e82") %>% 
  flair("objectToStore", background = "#81d4fa") %>% 
...
blogdown::shortcode("learnr",
                    url = "https://shelly-cooper.shinyapps.io/objectsPt1_quiz1_app3/",
                    id = "learnr-02-objectsQuiz1")
...
blogdown::shortcode("learnr",
                    url = "https://shelly-cooper.shinyapps.io/objectsPt1_quiz2_app4/",
                    id = "learnr-02-objectsQuiz2")
...
blogdown::shortcode("learnr",
                    url = "https://shelly-cooper.shinyapps.io/vectors_app5/",
                    id = "learnr-02-vectors")
