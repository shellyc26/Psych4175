...
This class is designed a little too easily where each assignment is just worth that amount of points and there are 200 points total. So we're not going to use this class (because seriously, it's just counting up raw points). We'll use a hypothetical class. In our hypothetical class:
