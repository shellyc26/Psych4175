...
- [<i class="fas fa-file-csv"></i> `hcp-demos.csv`](/assignments/hcp-demos.csv)
- [<i class="fas fa-file-csv"></i> `hcp-personality.csv`](/assignments/hcp-personality.csv)
- [<i class="fas fa-file-csv"></i> `hcp-cognitive.csv`](/assignments/hcp-cognitive.csv)
...
- Many participants were randomly removed to ensure that it's different from the original. It also will save you some computational resources. You have access to a random selection of 100 participants out of 1200.
...
You can find the grading rubric on Canvas. This assignment is worth **20 points total**

- Each of the 4 sections are worth 5 points each in total
- 3 of the points will be for accuracy (including code and interpretations)
- 2 points will be for pretty code (is it easy to read, do your naming conventions make sense, do you go to new lines when appropriate, is it easy to reproduce your code etc.). 

:::note

- You MUST use a RNotebook for this assignment. You will submit 3 files:
...
- At some point, you will need to use the following line in your code. You should copy/paste this directly. Where you put it is up to you. It replaces dots with dashes. `mutate_at(vars("Age"), ~str_replace(string = ., pattern = "\\.", replacement = "-"))`
...
- You will run your regression with your simulated data 5000 times such that you get an output vector of 5000 values. You are NOT simulating anything else from the regression.
    * HINT: go back to the mini assignments and look for clues
