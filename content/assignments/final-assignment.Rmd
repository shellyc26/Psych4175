...
Pick 2 variables. You are going to run a $t$-test to see if there are any significant differences between the mean of variable 1 and the mean of variable 2. Run this test.
...
For the same 2 variables above, bootstrap Cohen's $d$:
...
- Run the $t$-test
- Bootstrap Cohen's $d$ (using between 100 and 1000 iterations; you can choose the exact number)
