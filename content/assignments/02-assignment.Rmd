...
-   Use the `describe()` function from the `psych` package to get summary statistics of your numeric/integer columns *only*. You do not need to include things like participant ID in this -- just the variables you might care about in an actual analysis. For large datasets, you can just choose 3-4 columns. 
