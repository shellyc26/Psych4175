...
- Conduct 3 hypothesis tests from your dataset. Choose any statistical tests that come from the `Comparing Means` lecture. For each of the 3 tests you need to:
    ...
    - Write 2-5 sentences interpreting the results including interpreting the p-value, and confidence intervals (if shown)
:::
...
- If you currently work in a lab (or have previously worked in a lab), describe 2 things that your lab could improve upon to better support rigorous Psych/Neuro research. If you do not work in a lab (and you have not previously worked in one), describe 2 things that you could do better with your assignments in this class that would better adhere to Open Science standards. 
:::
