...
- Previously, we had 1 predictor
    * __Continuous__: A 1-unit change in X predicts a $b1$ change in Y
    * __Categorical__: A 1-unit change in X predicts a $b1$ change in Y, except a 1-unit change is going from category coded as 0 to category coded as 1
