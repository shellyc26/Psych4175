...
You should be able to show your students that if you add in random noise (which is the same as adding in measurement error), the correlation changes substantially. Thus, it's important to measure your variables as best as possible.
