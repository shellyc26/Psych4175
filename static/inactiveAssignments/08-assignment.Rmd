...
- Make 2 scatter plots of your data with a best fit line indicating the correlation. In the first scatter plot use the raw data. In the second scatter plot, use the same variables but standardized (z-score) them. Write a sentence describing if the line is the same or if it's different, and explain why this is the case. 
:::
...
- 2 continuous variables and 2 categorical variables
- One of your categorical variables should have 3 or more levels
- One of the continuous variables will be your OUTCOME measure (or your $Y$ variable). Please use this same variable as the outcome for all of the analyses described below. 
...
- Run a oneway ANOVA with your categorical variable that has 3 or more levels and your outcome variable. Now re-run that same model but as a regression instead. Write 2-3 sentences interpreting your models and again describing what is the same and what is different. Do your best to interpret each regression coefficient *and* the overall model (omnibus test). 
- Now run an ANOVA with both of your categorical variables predicting your outcome variable. Then re-run that same model as a regression. Write 2-3 sentences interpreting your models and again describing what is the same and what is different.
:::
